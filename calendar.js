...
// convert ical to calendar and event objects
export function parse(ical) {
  let calendar = {};
  let events = [];

  let jcal = icaljs.parse(ical.toString());
...
// NOTE: ical-generator will modify input events, so a copy is made before
//       passing the original events to ical-generator
